...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:nabuto\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=557598773508:+55 759877-3508\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `olá ◤◢ @${num.split('@')[0]} ◤◢◣\nbem vindo(a) ao grupo:n/━━━━❰･ *${mdata.subject}* ･❱━━━━\n\npor favor leia as regras \n e seja feliz🤗️`
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD E-GRILO BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, mn. Você não está registrado como amigo do sad. Registre-se para fazer amizade com o bot e-grilo por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar sad|18\n\n──「 e-grilo bot 」──`,
			...
			const ownerNumber = ["557598773508@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"557598773508@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["557598773508@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["557598773508@s.whatsapp.net"]//ubah nomor lo
			const premium = ["557598773508@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
//@nabutoYT					
    ...
    break
            ...
            case 'rapL':
				...
				case 'daftar':
					client.updatePresence(from, Presence.composing)
					if (args.length < 1) return reply(`Parameter Salah\nCommand : ${prefix}daftar nama|umur\nContoh : ${prefix}daftar SADBOY|18`)
			...
			case 'instaimg':
				...
				break
                                case 'afk':
                                        ...
                                        break 
				case 'indo10':
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o sad boy para ter acesso Premium!' ,text, { quoted: mek })
...
// recursos anime, random @nabuto domina vida
          ...
          reply('Espere..')
			    ...
			    case 'owner':
			    case 'dono':
                    client.sendMessage(from, {displayname: "sadboy", vcard: vcard}, MessageType.contact, { quoted: mek})
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "sadboy"🙄, chama ele aí ele diz que é "Shitpost"',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'criador':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nome: Sad boy\n contato: wa.me/557598773508\n Nome do bot: E-Grilo\n status do bot: On'})
					break
				case 'cavalo':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTCtZ2x23s2K3M0ghS6H9sa9Kgfhnu-1o8KyA&usqp=CAU`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'cavalo Peaky Blinder?😳'})
					break
                case 'dog':
                case 'auau':
                case 'cachorro':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do sad:*\n\n num tenho 😂'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* SAD BOY\n*WPP:* wa.me/+557598773508\n*\n\nEspro que goste do bot️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
